...
public interface ISysJobService {
     ...
     * @return 定时任务列表
     */
    IPage<JobAndTrigger> list(Integer currentPage, Integer pageSize) throws SchedulerException;


    IPage<JobAndTrigger> selectPageVo(Page<?> page) throws SchedulerException;
